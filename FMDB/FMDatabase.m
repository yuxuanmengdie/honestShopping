...
-(NSString*) trim:(NSString*)datatrim
{
	NSString* ret = [datatrim stringByTrimmingCharactersInSet: [NSCharacterSet whitespaceAndNewlineCharacterSet]];
	return ret;
}
